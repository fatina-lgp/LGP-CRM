...
export const STANDARD_OBJECTS = {
  ...
  discoveryCall: {
    universalIdentifier: '30303030-b001-4001-8001-000000000001',
    fields: {
      id: { universalIdentifier: '30303030-b001-4001-8001-f00000000001' },
      createdAt: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000002',
      },
      updatedAt: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000003',
      },
      deletedAt: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000004',
      },
      calendarEvent: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000005',
      },
      lead: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000006',
      },
      opportunity: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000007',
      },
      callType: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000008',
      },
      callStatus: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000009',
      },
      recordingUrl: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000a',
      },
      duration: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000b',
      },
      scheduledAt: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000c',
      },
      completedAt: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000d',
      },
      aiSummary: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000e',
      },
      actionItems: {
        universalIdentifier: '30303030-b001-4001-8001-f0000000000f',
      },
      attendeeCount: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000010',
      },
      owner: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000011',
      },
      position: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000012',
      },
      createdBy: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000013',
      },
      updatedBy: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000014',
      },
      searchVector: {
        universalIdentifier: '30303030-b001-4001-8001-f00000000015',
      },
    },
    indexes: {
      leadIdIndex: {
        universalIdentifier: '30303030-b001-4001-8001-i00000000001',
      },
      opportunityIdIndex: {
        universalIdentifier: '30303030-b001-4001-8001-i00000000002',
      },
      calendarEventIdIndex: {
        universalIdentifier: '30303030-b001-4001-8001-i00000000003',
      },
      callStatusIndex: {
        universalIdentifier: '30303030-b001-4001-8001-i00000000004',
      },
      searchVectorGinIndex: {
        universalIdentifier: '30303030-b001-4001-8001-i00000000005',
      },
    },
    views: {
      allDiscoveryCalls: {
        universalIdentifier: '30303030-b001-4001-8001-v00000000001',
        viewFields: {
          callType: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000001',
          },
          callStatus: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000002',
          },
          lead: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000003',
          },
          scheduledAt: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000004',
          },
          duration: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000005',
          },
          owner: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000006',
          },
          createdAt: {
            universalIdentifier: '30303030-b001-4001-8001-vf0000000007',
          },
        },
      },
    },
  ...
  documentTracking: {
    universalIdentifier: '30303030-b002-4001-8001-000000000001',
    fields: {
      id: { universalIdentifier: '30303030-b002-4001-8001-f00000000001' },
      createdAt: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000002',
      },
      updatedAt: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000003',
      },
      deletedAt: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000004',
      },
      documentName: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000005',
      },
      documentType: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000006',
      },
      documentUrl: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000007',
      },
      eventType: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000008',
      },
      eventTimestamp: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000009',
      },
      lead: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000a',
      },
      opportunity: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000b',
      },
      recipientEmail: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000c',
      },
      ipAddress: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000d',
      },
      userAgent: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000e',
      },
      position: {
        universalIdentifier: '30303030-b002-4001-8001-f0000000000f',
      },
      createdBy: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000010',
      },
      updatedBy: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000011',
      },
      searchVector: {
        universalIdentifier: '30303030-b002-4001-8001-f00000000012',
      },
    },
    indexes: {
      leadIdIndex: {
        universalIdentifier: '30303030-b002-4001-8001-i00000000001',
      },
      opportunityIdIndex: {
        universalIdentifier: '30303030-b002-4001-8001-i00000000002',
      },
      documentTypeIndex: {
        universalIdentifier: '30303030-b002-4001-8001-i00000000003',
      },
      eventTypeIndex: {
        universalIdentifier: '30303030-b002-4001-8001-i00000000004',
      },
    },
    views: {
      allDocumentEvents: {
        universalIdentifier: '30303030-b002-4001-8001-v00000000001',
        viewFields: {
          documentName: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000001',
          },
          documentType: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000002',
          },
          eventType: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000003',
          },
          lead: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000004',
          },
          eventTimestamp: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000005',
          },
          recipientEmail: {
            universalIdentifier: '30303030-b002-4001-8001-vf0000000006',
          },
        },
      },
    },
  ...
  intakeQualifier: {
    universalIdentifier: '30303030-b003-4001-8001-000000000001',
    fields: {
      id: { universalIdentifier: '30303030-b003-4001-8001-f00000000001' },
      createdAt: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000002',
      },
      updatedAt: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000003',
      },
      deletedAt: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000004',
      },
      lead: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000005',
      },
      opportunity: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000006',
      },
      budgetOwner: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000007',
      },
      budgetAmount: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000008',
      },
      headcount: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000009',
      },
      decisionTimeline: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000a',
      },
      currentSolution: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000b',
      },
      painPoints: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000c',
      },
      eventDate: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000d',
      },
      tier: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000e',
      },
      isComplete: {
        universalIdentifier: '30303030-b003-4001-8001-f0000000000f',
      },
      submittedAt: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000010',
      },
      submittedBy: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000011',
      },
      position: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000012',
      },
      createdBy: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000013',
      },
      updatedBy: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000014',
      },
      searchVector: {
        universalIdentifier: '30303030-b003-4001-8001-f00000000015',
      },
    },
    indexes: {
      leadIdIndex: {
        universalIdentifier: '30303030-b003-4001-8001-i00000000001',
      },
      opportunityIdIndex: {
        universalIdentifier: '30303030-b003-4001-8001-i00000000002',
      },
      isCompleteIndex: {
        universalIdentifier: '30303030-b003-4001-8001-i00000000003',
      },
    },
    views: {
      allIntakeQualifiers: {
        universalIdentifier: '30303030-b003-4001-8001-v00000000001',
        viewFields: {
          lead: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000001',
          },
          budgetOwner: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000002',
          },
          headcount: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000003',
          },
          tier: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000004',
          },
          isComplete: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000005',
          },
          decisionTimeline: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000006',
          },
          submittedAt: {
            universalIdentifier: '30303030-b003-4001-8001-vf0000000007',
          },
        },
      },
    },
  ...
  lead: {
    universalIdentifier: '30303030-a001-4001-8001-000000000001',
    fields: {
      id: { universalIdentifier: '30303030-a001-4001-8001-f00000000001' },
      createdAt: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000002',
      },
      updatedAt: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000003',
      },
      deletedAt: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000004',
      },
      firstName: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000005',
      },
      lastName: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000006',
      },
      email: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000007',
      },
      phone: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000008',
      },
      jobTitle: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000009',
      },
      linkedinLink: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000a',
      },
      leadScore: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000b',
      },
      leadStatus: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000c',
      },
      intakeSource: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000d',
      },
      intakeSourceDetail: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000e',
      },
      industry: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000000f',
      },
      companyName: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000010',
      },
      companySize: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000011',
      },
      annualRevenue: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000012',
      },
      region: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000013',
      },
      engagementLevel: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000014',
      },
      lastContactedAt: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000015',
      },
      lastScoredAt: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000016',
      },
      scoringNotes: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000017',
      },
      position: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000018',
      },
      createdBy: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000019',
      },
      updatedBy: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001a',
      },
      searchVector: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001b',
      },
      company: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001c',
      },
      owner: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001d',
      },
      taskTargets: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001e',
      },
      noteTargets: {
        universalIdentifier: '30303030-a001-4001-8001-f0000000001f',
      },
      favorites: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000020',
      },
      attachments: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000021',
      },
      timelineActivities: {
        universalIdentifier: '30303030-a001-4001-8001-f00000000022',
      },
    },
    indexes: {
      companyIdIndex: {
        universalIdentifier: '30303030-a001-4001-8001-i00000000001',
      },
      ownerIdIndex: {
        universalIdentifier: '30303030-a001-4001-8001-i00000000002',
      },
      leadStatusIndex: {
        universalIdentifier: '30303030-a001-4001-8001-i00000000003',
      },
      searchVectorGinIndex: {
        universalIdentifier: '30303030-a001-4001-8001-i00000000004',
      },
    },
    views: {
      allLeads: {
        universalIdentifier: '30303030-a001-4001-8001-v00000000001',
        viewFields: {
          firstName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000001',
          },
          lastName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000002',
          },
          email: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000003',
          },
          companyName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000004',
          },
          leadScore: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000005',
          },
          leadStatus: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000006',
          },
          intakeSource: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000007',
          },
          owner: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000008',
          },
          createdAt: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000009',
          },
        },
      },
      byStatus: {
        universalIdentifier: '30303030-a001-4001-8001-v00000000002',
        viewFields: {
          firstName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000011',
          },
          lastName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000012',
          },
          email: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000013',
          },
          leadScore: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000014',
          },
          companyName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000015',
          },
          owner: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000016',
          },
        },
        viewGroups: {
          new: {
            universalIdentifier: '30303030-a001-4001-8001-vg0000000001',
          },
          contacted: {
            universalIdentifier: '30303030-a001-4001-8001-vg0000000002',
          },
          qualified: {
            universalIdentifier: '30303030-a001-4001-8001-vg0000000003',
          },
          unqualified: {
            universalIdentifier: '30303030-a001-4001-8001-vg0000000004',
          },
          converted: {
            universalIdentifier: '30303030-a001-4001-8001-vg0000000005',
          },
        },
      },
      leadRecordPageFields: {
        universalIdentifier: '30303030-a001-4001-8001-v00000000003',
        viewFieldGroups: {
          general: {
            universalIdentifier: '30303030-a001-4001-8001-vfg000000001',
          },
          firmographics: {
            universalIdentifier: '30303030-a001-4001-8001-vfg000000002',
          },
          scoring: {
            universalIdentifier: '30303030-a001-4001-8001-vfg000000003',
          },
          other: {
            universalIdentifier: '30303030-a001-4001-8001-vfg000000004',
          },
        },
        viewFields: {
          firstName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000021',
          },
          lastName: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000022',
          },
          email: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000023',
          },
          phone: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000024',
          },
          jobTitle: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000025',
          },
          linkedinLink: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000026',
          },
          company: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000027',
          },
          owner: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000028',
          },
          leadStatus: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000029',
          },
          intakeSource: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002a',
          },
          intakeSourceDetail: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002b',
          },
          industry: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002c',
          },
          companyName: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002d',
          },
          companySize: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002e',
          },
          annualRevenue: {
            universalIdentifier: '30303030-a001-4001-8001-vf000000002f',
          },
          region: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000030',
          },
          leadScore: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000031',
          },
          engagementLevel: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000032',
          },
          lastContactedAt: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000033',
          },
          lastScoredAt: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000034',
          },
          scoringNotes: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000035',
          },
          createdAt: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000036',
          },
          createdBy: {
            universalIdentifier: '30303030-a001-4001-8001-vf0000000037',
          },
        },
      },
    },
