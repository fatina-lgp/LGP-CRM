...
// Single LGP QMA workspace — use the YCombinator ID slot for compatibility
...
// Convenience alias
export const SEED_LGP_WORKSPACE_ID = SEED_YCOMBINATOR_WORKSPACE_ID;
...
export const SEEDER_CREATE_WORKSPACE_INPUT = {
  // Primary LGP QMA workspace
  [SEED_YCOMBINATOR_WORKSPACE_ID]: {
    id: SEED_YCOMBINATOR_WORKSPACE_ID,
    displayName: 'LGP QMA',
    subdomain: 'lgp',
    inviteHash: 'lgp.qma-invite-hash',
    logo: '/images/lgp-logo.png',
    activationStatus: WorkspaceActivationStatus.PENDING_CREATION,
    isTwoFactorAuthenticationEnforced: false,
  },
  // Secondary slot — kept for type compatibility but unused
  [SEED_APPLE_WORKSPACE_ID]: {
    id: SEED_APPLE_WORKSPACE_ID,
    displayName: 'LGP Alt',
    subdomain: 'lgp-alt',
    inviteHash: 'lgp.alt-invite-hash',
    logo: '/images/lgp-logo.png',
    activationStatus: WorkspaceActivationStatus.PENDING_CREATION,
    isTwoFactorAuthenticationEnforced: false,
  },
