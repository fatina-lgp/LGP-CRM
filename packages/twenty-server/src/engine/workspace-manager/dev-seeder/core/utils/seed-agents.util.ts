  ...
  if (workspaceId === SEED_APPLE_WORKSPACE_ID) {
    ...
    messageParts = [
      ...
      },
      {
        ...
        type: 'text',
        textContent:
          'Hello! I can help you analyze client trends and pipeline performance. From your LGP QMA workspace data, I can see strong performance in promotional products and branded merchandise deals, particularly in B2B corporate swag and trade show activations. Several opportunities are showing strong close rates this quarter. Would you like me to provide specific deal performance metrics or focus on broader pipeline trends?',
        createdAt: new Date(baseTime.getTime() + 3 * 60 * 1000),
      },
      {
        id: partIds[2],
